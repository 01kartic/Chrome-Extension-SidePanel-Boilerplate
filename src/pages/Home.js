...
function Home() {
  return (
    <div className="text-center">
      ...
      <p className="text-neutral-600 mt-12">by <a target='_blank' href="https:///x.com/01_kartic" className="mt-4 text-bold text-blue-500 hover:text-blue-600">Kartic</a></p>
    </div>
  );
}
